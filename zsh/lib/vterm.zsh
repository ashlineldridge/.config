# This file provides enhanced emacs-libvterm integration. It's been copied from:
# https://github.com/akermu/emacs-libvterm/blob/master/etc/emacs-vterm-zsh.sh.
# More details here: https://github.com/akermu/emacs-libvterm/tree/master#shell-side-configuration.
...
# various symbols ("%2~" below will replace $HOME with '~' and print 2 dir levels).
autoload -U add-zsh-hook
add-zsh-hook -Uz chpwd () { print -Pn "\e]2;%2~\a" }

# Force the buffer name to be updated now.
chpwd
