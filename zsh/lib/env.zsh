...
# Path
export PATH="/usr/local/bin:/usr/local/opt/coreutils/libexec/gnubin:/usr/local/opt/findutils/libexec/gnubin:/usr/local/opt/gettext/bin:/usr/local/opt/llvm/bin:/usr/local/kubebuilder/bin:${GOROOT}/bin:${GOPATH}/bin:/usr/bin:/bin:/usr/local/sbin:/usr/sbin:/sbin:${HOME}/.cargo/bin:${HOME}/bin:${HOME}/.local/bin"
